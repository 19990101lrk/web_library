...
public class OrderServlet extends HttpServlet {
	...
	//删除订单
	private void delOrder(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		String ordernum = req.getParameter("ordernum");
		service.delOrder(ordernum);
		HttpSession session = req.getSession();
		List<Order> lists = (List<Order>) session.getAttribute("orders");
		...
		resp.sendRedirect(req.getContextPath() + "/personalCenter.jsp");
	}
